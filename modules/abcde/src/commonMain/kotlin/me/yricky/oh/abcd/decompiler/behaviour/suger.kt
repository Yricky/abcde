...
val Operation.Assign.isLeftAcc: Boolean get() = leftReg == FunSimCtx.RegId.ACC
val Operation.Assign.isLeftContainsAcc: Boolean get() = isLeftAcc ||
...
val Operation.Assign.isRightAcc: Boolean get() = (right as? Operation.LoadReg)?.regId == FunSimCtx.RegId.ACC
val Operation.Assign.isRightContainsAcc: Boolean get() = right.effected().contains(FunSimCtx.RegId.ACC) ||
        right.read().contains(FunSimCtx.RegId.ACC)
